    ...
    <div class="container">
        <div class="row">
            <div class="post-menu-view">
                <div class="col-md-6">
                    <img src="{{ env('MEDIA_URL').$productdetails->product_image }}"
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ url('addtocart/'. $productdetails->id) }}"
                        class="btn-solid rounded mt20">Add to Cart</button>
                        <a><a href="{{ url('addtowishlist/'. $productdetails->id) }}"><i
                                    class="fa fa-heart-o shopping-icon"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-6 col-md-2 mb30">
            <a href="{{ url('productdetails/'.$value['id']) }}">
                <div class="post-menu s1">
                    <img src="{{ env('MEDIA_URL').$value['product_image'] }}"
                        class="img-responsive enlarge" alt="">
                    <div class="sub-item-service meta">
                        <div class="c1" style="word-wrap: break-word;"><a
                                href="{{ url('productdetails/'.$value['id']) }}">{{ $value['name'] }}</a>
                        </div>
                        <div class="c3"><a
                                href="{{ url('productdetails/'.$value['id']) }}">${{ $value['price'] }}</a>
                        </div>
                    </div>
                    <div class="service-text meta-content"><a
                            href="{{ url('productdetails/'.$value['id']) }}">{{ $value['product_description'] }}</a>
                    </div>
                </div>
            </a>
        </div>
