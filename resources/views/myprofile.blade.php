...
<div id="content">
   <div class="container myprofile">
      <div class="col-md-3">
         <div class="tab">
            <button class="tablinks" onclick="openCity(event, 'dashboard')" id="defaultOpen">Dashboard <i class="fa fa-home"></i></button>
            <button class="tablinks" onclick="openCity(event, 'address')">Address <i class="fa fa-map-marker"></i></button>            
            <button class="tablinks" onclick="openCity(event, 'myorder')">My Order's <i class="fa fa-shopping-bag"></i></button>
            <button class="tablinks" onclick="openCity(event, 'accountdetails')">Account Details <i class="fa fa-user"></i></button>
            <button class="tablinks" onclick="openCity(event, 'changepassword')">Change Password <i class="fa fa-lock"></i></button>            
            <a href="index.php"><button class="tablinks" style="color: #ca8e46;">Logout <i class="fa fa-sign-out flot-right"></i></button></a>
         </div>
      </div>
      <div class="col-md-9">
         ...
         <div id="myorder" class="tabcontent">
            <div class="contact-form-box">
               ...
               <div class="product-order-detail">
                  ...
                  <img src="{!!asset('public/assets/images/menu/beef-three-cheese-bolognese-300x257.png')!!}" class="blur-up lazyloaded" alt="">
                  </a>
