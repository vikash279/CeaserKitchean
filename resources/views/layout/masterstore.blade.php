...
<html lang="en">
   ...
   <body id="homepage">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div id="logo">
                        <a href="{{url('index')}}">
                        <img class="logo" src="{!!asset('public/assets/images/caesarskitchen_logo.png')!!}" alt="">
                        </a>
                     </div>
                     <!-- logo close -->
                     <!-- small button begin -->
                        ...
                        <ul id="mainmenu">
                           ...
                           <li>
                              <div class="profile-dropdown">
                                 <a href="#" class="profile-dropbtn">Vicki E. Pope &nbsp
                                 <img src="{!!asset('public/assets/images/team/team_pic_3.jpg')!!}" alt="img" class="w-px-40 h-auto rounded-circle"> </a>
                                 <div class="profile-dropdown-content">
                                    <a href="{{url('myprofile')}}"><i class="fa fa-user mr-10"></i> My Profile</a>
                                    <a href="{{url('cart')}}"><i class="fa fa-shopping-cart mr-10"></i> Shopping Cart</a>
                                    <a href="{{url('wishlist')}}"><i class="fa fa-heart-o mr-10"></i>My Wishlist</a>                            
                                    <a href="{{url('store')}}"><i class="fa fa-power-off mr-10"></i> Sign out</a>
                                 </div>
                              </div>
                           </li>
                        </ul>
               ...
               <div class="row">
                  <div class="container">
                     ...
                     <div class="col-md-4 text-center">
                        <img class="logo" src="{!!asset('public/assets/images/caesarskitchen_logo.png')!!}" alt="logo">
                     </div>
                     <div class="col-md-4 text-right">
      ...
      <!-- RS5.0 Core JS Files -->
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/jquery.themepunch.tools.min838f.js?rev=5.0')!!}"></script>
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/jquery.themepunch.revolution.min838f.js?rev=5.0')!!}"></script>
      <!-- RS5.0 Extensions Files -->
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/extensions/revolution.extension.video.min.js')!!}"></script>
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/extensions/revolution.extension.slideanims.min.js')!!}"></script>
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/extensions/revolution.extension.layeranimation.min.js')!!}"></script>
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/extensions/revolution.extension.navigation.min.js')!!}"></script>
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/extensions/revolution.extension.actions.min.js')!!}"></script>
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/extensions/revolution.extension.kenburn.min.js')!!}"></script>
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/extensions/revolution.extension.migration.min.js')!!}"></script>
      <script type="text/javascript" src="{!!asset('public/assets/revolution/js/extensions/revolution.extension.parallax.min.js')!!}"></script>
      <script>
